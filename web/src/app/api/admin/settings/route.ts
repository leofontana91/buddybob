...
const patchSchema = z.object({
  ...
  callOperatorNotifyInbox: z.boolean().optional(),
  callOperatorNotifyPopup: z.boolean().optional(),
  callOperatorNotifyEmail: z.boolean().optional(),
  callOperatorEmail: z
    .union([z.literal(""), z.string().email()])
    .optional(),
  rubricaEnabled: z.boolean().optional(),
  rubricaCollectPhone: z.boolean().optional(),
  rubricaCollectEmail: z.boolean().optional(),
  rubricaCollectCompany: z.boolean().optional(),
  rubricaCollectNotes: z.boolean().optional(),
...
export async function PATCH(req: Request) {
  ...
  const updated = await prisma.robotSettings.upsert({
    ...
    create: {
      ...
      callOperatorNotifyInbox: settings.callOperatorNotifyInbox ?? true,
      callOperatorNotifyPopup: settings.callOperatorNotifyPopup ?? false,
      callOperatorNotifyEmail: settings.callOperatorNotifyEmail ?? false,
      callOperatorEmail: settings.callOperatorEmail ?? "",
      rubricaEnabled: settings.rubricaEnabled ?? true,
      rubricaCollectPhone: settings.rubricaCollectPhone ?? true,
      rubricaCollectEmail: settings.rubricaCollectEmail ?? true,
      rubricaCollectCompany: settings.rubricaCollectCompany ?? false,
      rubricaCollectNotes: settings.rubricaCollectNotes ?? true,
